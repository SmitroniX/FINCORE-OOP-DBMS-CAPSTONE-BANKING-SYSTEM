...
INSERT INTO users (id, username, password, full_name, role, status)
VALUES (seq_users.NEXTVAL, 'john_doe', 'password123', 'John Doe', 'USER', 'ACTIVE');
...
-- 3. Insert Accounts (Savings & Checking with Polymorphic behavior)
...
-- 4. Insert Financial Records (Income & Expenses for CRUD demonstration)
...
INSERT INTO financial_records (id, record_type, category, amount, account_number, description, record_date)
VALUES (seq_fin_records.NEXTVAL, 'EXPENSE', 'Entertainment', 120.00, 'CHK-100102', 'Streaming Services & Cinema Tickets', SYSDATE - 2);
...
-- 7. Insert Initial Audit Log
INSERT INTO audit_logs (id, action, entity_type, entity_id, performed_by, details)
VALUES (seq_audit_logs.NEXTVAL, 'SYSTEM_BOOTSTRAP', 'SYSTEM', 'ROOT', 'SystemInitializer', 'FinCore Oracle Database seeded with verified data.');
